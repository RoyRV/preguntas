const questions = {
  ES: [
    ...
    "	has visto porno y en un momento dijiste, esto es mucho?	",
    ...
    "	cantas en la ducha? que cancion?	",
  ],
  ...
  EN: [
    ...
    "	Have you seen porn and at one point you said, this is a lot?	",
    ...
    "	you sing in the shower? what song?	",
  ],
};
